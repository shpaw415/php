...
auth_email="shpaw400@gmail.com"   # The email used to login 'https://dash.cloudflare.com'
auth_method="token"               # Set to "global" for Global API Key or "token" for Scoped API Token
auth_key=$1                       # Your API Token or Global API Key
zone_identifier=$2                # Can be found in the "Overview" tab of your domain
record_name=$3                    # Which record you want to be synced
ttl="3600"                        # Set the DNS TTL (seconds)
proxy=$4                          # Set the proxy to true or false
